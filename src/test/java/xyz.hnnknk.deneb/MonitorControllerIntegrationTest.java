...
public class MonitorControllerIntegrationTest {
    ...
    public void testDeleteSuccess() throws Exception {
        ...
        long id = this.monitorService.listAllMonitors().get(0).getId();

        mockMvc.perform(delete("/components/monitor/" + id))
    ...
    public void testUpdateSuccess() throws Exception {
        ...
        mockMvc.perform(put("/components/monitor/" + id).content(d).contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk());
    ...
    public void testGetAllNoContent() throws Exception {
        ...
        for(Monitor mon : this.monitorService.listAllMonitors()) {
            this.monitorService.delete(mon.getId());
        }
